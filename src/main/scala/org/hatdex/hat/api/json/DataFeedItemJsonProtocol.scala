...
trait DataFeedItemJsonProtocol extends JodaWrites with JodaReads {
  implicit protected val locationGeoFormat: Format[LocationGeo]         = Json.format[LocationGeo]
  implicit protected val locationAddressFormat: Format[LocationAddress] = Json.format[LocationAddress]
  implicit protected val locationFormat: Format[DataFeedItemLocation]   = Json.format[DataFeedItemLocation]
  implicit protected val mediaFormat: Format[DataFeedItemMedia]         = Json.format[DataFeedItemMedia]
  implicit protected val dataFeedNestedStructureItemFormat: Format[DataFeedNestedStructureItem] =
    Json.format[DataFeedNestedStructureItem]
  implicit protected val contentFormat: Format[DataFeedItemContent] = Json.format[DataFeedItemContent]
  implicit protected val titleFormat: Format[DataFeedItemTitle]     = Json.format[DataFeedItemTitle]

  implicit val feedItemWrites: Writes[DataFeedItem] = ((JsPath \ "source").write[String] and
  ...
  implicit val feedItemReads: Reads[DataFeedItem] = ((JsPath \ "source").read[String] and
