...
trait DataStatsFormat extends DataDebitFormats {
  ...
  protected implicit val richDataDebitFormat = RichDataJsonFormats.richDataDebitFormat
  protected implicit val dataDebitFormat = RichDataJsonFormats.dataDebitFormat
  protected implicit val dataDebitEventFormat: Format[DataDebitEvent] = Json.format[DataDebitEvent]
  protected implicit val dataDebitOperationFormat: Format[DataDebitOperation] = Json.format[DataDebitOperation]
